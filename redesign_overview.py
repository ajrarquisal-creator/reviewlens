...
old_import = "from src.genai_client import analyze_review, compute_priority, draft_reply, summarize_themes"
...
new_block = """    with tab_overview:
        ...
        k6.metric("\u26A1 AI/Rating Conflicts", conflict_count)
...
if old_block in content:
    ...
    print("Redesigned Overview tab with KPI row and grouped sections.")
else:
    print("Overview block not found - manual check needed.")
